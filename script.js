...
const FINGER_ASSETS = ['assets/finger_tiger.webp?v=15','assets/finger_peacock.webp?v=15','assets/finger_koala.webp?v=15','assets/finger_owl.webp?v=15'];
...
const MUSIC_SRC = 'audio/bgm.mp3?v=2';
  ...
  try{
    ...
    if(menuMatch){
      ...
      fingers.forEach((el, i) => {
        el.src = `assets/menu_hand_clean_${i+1}.png?v=15`;
      });
